...
%folder of stimuli
cd C:\Users\teresa\Documents\UZH_Arbeit\Human_instrument_morphing\Experiment_trials\Instrument_task
filedir='C:\Users\teresa\Documents\UZH_Arbeit\Human_instrument_morphing\Experiment_trials\Instrument_task\'
condition_dir='..\Experiment_trials\Instrument_task\'
filelist=dir('*.wav')
...
writetable(mytable,'conditions_Instrument.csv', 'Delimiter',',')

newtable = addvars(newtable,trialnr,'Before','trial');
writetable(newtable,'conditions_Instrument_rand.csv', 'Delimiter',',') 
